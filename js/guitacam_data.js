var guitacam_data = {
	"profesores":[
		{
			"cod":"P1",
			"nombre":"Lidia Rodríguez Gómez",
			"especialidad": "Canto",
			"resumen":"Profesora con énfasis en canto Lírico y Popular. Ganadora del concurso Recital de Honor en la UCR, 2015 con amplia experiencia al impartir clases para todas las edades, con amplios estudios a nivel universitario y experiencia internacional.",
		...
		{
			"cod":"P3",
			"nombre":"Cristhopher Madrigal González",
			"especialidad": "Violín",
			"resumen":"Profesor con años de experiencia en la enseñanza del violín para todas las edades. Especialista en Método Suzuki con titulación y músico de alto nivel nacional e internacional.",
		...
		{
			"cod":"P4",
			"nombre":"Andrés Araya Saborío.",
			"especialidad": "Piano - Teclado",
			"resumen":"Uno de nuestros profesores más exigentes y carismáticos con su instrumento. El piano es su pasión y en cada clase aplica el uso de técnicas y metodologías que hagan al estudiante sacar todo su potencial.",
